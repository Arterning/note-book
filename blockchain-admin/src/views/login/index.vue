 ...
 * @LastEditTime : 2022-09-13 11:13:48
 * @FilePath     : \blockchain-admin\src\views\login\index.vue
-->
<template>
  <div class="login-container">
    ...
    <div class="qrcode-box">
      <div class="qrcode-item">
        ...
        <div class="text-box">智农云小程序(种植)</div>
      </div>
      <div class="qrcode-item">
        <div class="img-box">
          <img src="../../assets/images/sy.jpg" alt="" />
        </div>
        <div class="text-box">溯源小程序(加工)</div>
      </div>
    </div>
    ...
    <login-window
      ...
      @setPassword="dialogFormVisible = true"
    >
      <div class="window-title">智农云区块链溯源管理平台</div>
    ...
    >
      ...
      <set-password-form
        ...
        @submit-loading="submitLoading = $event"
