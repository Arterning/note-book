 ...
 * @LastEditTime : 2022-08-24 16:02:12
 * @FilePath     : \blockchain-admin\src\views\system-manage\role\components\RoleList.vue
-->
<template>
  <div class="role-list">
    <div class="scroll-area">
      ...
      <i-action @on-query="getListData" @on-reset="onReset">
        ...
        <template #action>
          <el-button type="primary" @click="onAdd" v-btn-permission:1718
            >新 建</el-button
          >
        </template>
      </i-action>
      ...
      <div class="list">
        ...
        <div class="empty" v-if="listData.length === 0">暂无角色信息</div>
      </div>
