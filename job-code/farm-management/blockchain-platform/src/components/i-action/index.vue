 ...
 * @LastEditTime : 2022-07-04 16:22:06
 * @FilePath     : \blockchain-platform\src\components\i-action\index.vue
-->
<template>
  <div class="i-action">
    <div class="left-side" ref="leftSide">
      ...
      <!-- 自定义左侧内容区 -->
      <div style="height: 52px; padding-bottom: 16px; display: flex" v-else>
        <slot></slot>
      </div>
    </div>
