...
func New(keyStore bccsp.KeyStore) (bccsp.BCCSP, error) {
	// Init config
	conf := &config{}
	err := conf.setSecurityLevel()
	if err != nil {
		return nil, errors.Wrapf(err, "Failed initializing configuration at [%v,%v]")
	}
	...
	verifiers[reflect.TypeOf(&sm2PublicKey{})] = &sm2PublicKeyVerifier{}
	...
	keyGenerators[reflect.TypeOf(&bccsp.SM2KeyGenOpts{})] = &sm2KeyGenerator{curve: elliptic.P256SM2()}
	...
	keyDerivers[reflect.TypeOf(&sm4PrivateKey{})] = &sm4PrivateKeyKeyDeriver{}
