...
public class Ch08SubStringTest {

	List<Org> orgs = AreaBuilder.initSize(20);
	public static void main(String[] args) throws RunnerException {
		Options opt = new OptionsBuilder().include(Ch08SubStringTest.class.getSimpleName()).forks(1).build();
		new Runner(opt).run();
	}

	@Benchmark
	public void subString() {
		AreaBuilder.buildProvinceWithSubString(orgs);
